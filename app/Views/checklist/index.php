...
<div class="container-fluid">
    <div class="row">
        <div class="col-11">
            <p class="fs-4 fw-bold my-3 text-light text-uppercase"><span class="bg-secondary rounded px-2">list peralatan</span></p>
        </div>
            ...
            <div class="col-xl-4 col-md-6 mb-3">
                ...
                <button type="button" class="rounded shadow border-0 p-0" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?= $row[0]; ?>" style="width: 100%;">
                    <div class="p-2 bg_hijau1 rounded-top border_bottom2 text-start">
                        ...
                        <p class="fw-bolder text-uppercase fs-5 d-inline-block mb-0 text-success text-right">checklist</p>
                    </div>
                            ...
                            <div class="modal-body">
                                <table class="table table-sm">
                                    <?php foreach ($row[1] as $ro) : ?>
                                        <tr>
                                            <td class="text-start">
                                                <a class="text-decoration-none text-dark" href="checklist/<?= $ro; ?>"><?= $ro; ?></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </table>
