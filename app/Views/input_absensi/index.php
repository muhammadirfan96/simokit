...
<div class="container-fluid">
    <div class="row">
        <div class="col-11">
            <p class="fs-4 fw-bold my-3 text-light text-uppercase"><span class="bg-secondary rounded px-2">input absensi</span></p>
        </div>
    ...
    <form action="/input_absensi/simpan" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-lg-2">
                <div class="rounded shadow bg_hijau0 pb-2" style="width: 100%;height:80%;">
                    <button class="btn text-light rounded" type="submit" style="width: 100%;height:100%;">SAVE</button>
                </div>
            </div>
        </div>
    </form>
