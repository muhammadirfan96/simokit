        ...
        <div class="col-md-6">
            <div class="shadow mb-3 p-3 rounded">
                ...
                <div class="d-flex flex-col">
                    ...
                    <div class="border border-dark border-1 rounded position-relative" style="width:50%;">
                        ...
                        <p class="text-center text-uppercase" style="font-size: 100px;"><?= $jadwalShift['masuk']; ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="shadow mb-3 p-3 rounded">
                ...
                <div class="d-flex flex-col justify-content-center" style="min-height:176px">
                    ...
                    <?php if ($tidakHadir != null) : ?>
                        ...
                        <div class="border border-dark border-1 rounded position-relative size12" style="width:50%;height:50%">
