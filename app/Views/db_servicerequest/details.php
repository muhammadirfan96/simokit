                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu overflow-auto" aria-labelledby="dropdownMenuButton1">
                            <?php foreach ($users as $user) : ?>
                                <li>
                                    <input class="form-check-input ms-2" type="checkbox" id="<?= $user['username']; ?>" name="<?= $user['username']; ?>" value="<?= $user['username']; ?>" <?= str_contains($servicerequest['diinput_oleh'], $user['username']) ? 'checked' : ''; ?>>
