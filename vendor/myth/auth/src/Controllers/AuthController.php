...
class AuthController extends Controller
{
	...
	public function register()
	{
		...
		$group = $this->GroupModel->asArray()->where('description', 1)->findAll();

		return $this->_render(
			$this->config->views['register'],
			[
				'config' => $this->config,
				'group' => $group
			]
	...
	public function attemptRegister()
	{
		...
		$rules = [
			...
			'username' => 'required|alpha_numeric_space|min_length[3]|max_length[15]|is_unique[users.username]',
		...
		// set default user grup
		$this->config->defaultUserGroup = $this->request->getPost('bidang');
